...
descriptions_targetpage = {
   ...
   'afterburner': 'Multiplicities, midrapidity yields, transverse momentum and rapidity spectra for the most abundant hadron species for afterburner runs \
                   at &radic;<span style="text-decoration: overline">s</span><sub>NN </sub> = 200 and 5000 GeV. The input are particle lists were generated by \
                   <a href="https://github.com/smash-transport/smash-vhlle-hybrid"> SMASH-vHLLE-hybrid</a> after the sampling stage using the default configuration',
