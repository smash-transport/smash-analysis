...
class DensityEvolution:
    def __init__(self, PFile, NDim, BoxLength, TimeStep):
        self.NDim = NDim
    ...
    def update_grid(self):
        ...
        for evaluation_time in self.TimeStep:
            ...
            event_counter = 0
            with BinaryReader(self.PFile) as reader:
...
RunClass = DensityEvolution(Loc, dim_grid, BoxLength, Times)
