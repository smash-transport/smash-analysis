...
def _read_binary_block_v10(bfile):
    """Read one output block from SMASH binary file."""
    particle_data_type = np.dtype([('r','d',4),('mass','d'),('p','d',4),('pdgid','i4'),('id','i4'),('charge','i4')])
    block_type = bfile.read(1).decode(encoding)
    if (block_type == 'p'):
...
def _read_binary_block_v7_extended(bfile):
    """Read one output block from SMASH binary file."""
    particle_data_type = np.dtype([('r','d',4),('mass','d'),('p','d',4),('pdgid','i4'),('id','i4'),('charge','i4'),('Ncoll','i4'),('formation_time','d'),('cross_section_scaling_factor','d'),('process_ID_origin','i4'),('process_type_origin', 'i4'),('time_of_origin','d'),('PDG_mother1','i4'),('PDG_mother2','i4')])
...
def _read_binary_block_v10_extended(bfile):
    """Read one output block from SMASH binary file."""
    particle_data_type = np.dtype([('r','d',4),('mass','d'),('p','d',4),('pdgid','i4'),('id','i4'),('charge','i4'),('Ncoll','i4'),('formation_time','d'),('cross_section_scaling_factor','d'),('process_ID_origin','i4'),('process_type_origin', 'i4'),('time_of_origin','d'),('PDG_mother1','i4'),('PDG_mother2','i4'),('baryon_number','i4'),('strangeness','i4')])
    ...
    def __init__(self, path):
        ...
        if self.format_version == 10:
            if self.format_extended == 1:
                self.__read_block = _read_binary_block_v10_extended
            elif self.format_extended == 0:
                self.__read_block = _read_binary_block_v10
        elif self.format_version == 9:
            if self.format_extended == 1:
            ...
            if self.format_extended == 1:
                ...
                self.__read_block = _read_binary_block_v7
