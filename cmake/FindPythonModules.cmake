function(find_python_module module)
    ...
    if(NOT PY_${module_upper}_FOUND)
        ...
        if(NOT status)
            ...
            if(FIND_PY_${module_upper}_REQUIRED)
                message(SEND_ERROR "Required python module ${module} NOT found (version ${FIND_PY_${module_upper}_VERSION} ${optionally}required).")
            else()
                message(STATUS "Optional python module ${module} NOT found (version ${FIND_PY_${module_upper}_VERSION} ${optionally}required).")
            endif()
        endif()
    endif()
endfunction()
